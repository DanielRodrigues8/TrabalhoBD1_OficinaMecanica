 ...
 * @author vini2
 */
public class ServicosVendas extends javax.swing.JFrame {
    ...
    public ServicosVendas() {
        ...
        try {
            ...
            java.sql.PreparedStatement statement = conex.prepareStatement(sql);
             ArrayList<Servico> serviços = new ArrayList<Servico>();
        ...
        while(result.next()){
            ...
            Servico func = new Servico(cod,preço,tipo);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       ServicosVendas.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServicosVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServicosVendas().setVisible(true);
            }
        });
    }
